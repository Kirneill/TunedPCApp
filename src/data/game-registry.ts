...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    ...
    risk: 'safe',
    requiresReboot: false,
    script: '25_Marathon_Settings.ps1',
    pathEnvVar: 'MARATHON_PATH',
    steamFolders: ['Marathon'],
    checkLabels: {
  ...
  },
  {
    id: 'overwatch2',
    name: 'Overwatch 2',
    subtitle: 'All Low · 600 FPS Cap · Reflex In-Game',
    description: 'Optimizes Settings_v0.ini -- All Low quality, SSAO off, 600 FPS cap, read-only lock. NVIDIA Reflex must be set in-game.',
    gradient: 'from-orange-600 via-orange-950 to-black',
    letter: 'OW2',
    risk: 'safe',
    requiresReboot: false,
    script: '26_Overwatch2_Settings.ps1',
    pathEnvVar: 'OVERWATCH2_PATH',
    steamFolders: ['Overwatch'],
    checkLabels: {
      OW2_EXE_FLAGS: 'Overwatch 2 EXE compatibility flags',
      OW2_CONFIG_WRITTEN: 'Overwatch 2 Settings_v0.ini written',
      OW2_SETTINGS_APPLIED: 'Overwatch 2 settings applied',
    },
    defaultEnabled: true,
  },
  {
